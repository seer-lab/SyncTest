...
// smoothly exchange positions asynchronously.
  ...
  public static void execute() { // for testing
      if (debug) {
...
final class AnimatorFrame
  ...
  void doCommand(AnimatorCommand command) {
    ...
    if (command instanceof AnimatorAction) {
      ...
      System.out.println("doCommand: illegal command");
    }
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon = ht.get(id)) == null) {
        System.out.println("Ccolor hashtable: no such id=" + id);
        return;
      }
    }
...
class Cfill
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon = ht.get(id)) == null) {
        System.out.println("Cfill hashtable: no such id=" + id);
        return;
      }
    }
    if (icon instanceof AnimatorShape) {
      ...
      System.out.println("Cfill: icon is not fillable, icon=" + icon);
    }
  }
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon = ht.remove(id)) == null) {
        System.out.println("Cdelete hashtable: no such id=" + id);
        return;
      }
    }
    synchronized (icons) {
      if (!icons.removeElement(icon)) {
        System.out.println("Cdelete vector: no such icon=" + icon);
        return;
      }
    }
  }
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon = (AnimatorIcon) ht.get(id)) == null) {
        System.out.println("Cjump hashtable: no such id=" + id);
        return;
      }
      if (id2 != null) {
        if ( (icon2 = (AnimatorIcon) ht.get(id2)) == null) {
          System.out.println("CmoveTo hashtable: no such id2=" + id2);
          return;
        }
      }
    }
    if (syncMode == XtangoAnimator.SYNC) {
      ...
      System.out.println("Cmove: illegal syncMode=" + syncMode);
    }
  }
  ...
  public void run() {
    ...
    synchronized (icon.position) { // for ASYNC move, there may be
      ...
      if (moveMode == RELATIVE) { // the position with another
        ...
        System.out.println("Cmove: illegal moveMode=" + moveMode);
      }
...
class CjumpRelative
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon = (AnimatorIcon) ht.get(id)) == null) {
        System.out.println("CjumpRelative hashtable: no such id=" + id);
        return;
      }
    }
    synchronized (icon.position) {
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon1 = (AnimatorIcon) ht.get(id1)) == null) {
        System.out.println("CjumpTo hashtable: no such id1=" + id1);
        return;
      }
      if ( (icon2 = (AnimatorIcon) ht.get(id2)) == null) {
        System.out.println("CjumpTo hashtable: no such id2=" + id2);
        return;
      }
    }
    synchronized (icon2.position) {
...
class CexchangePos
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon1 = (AnimatorIcon) ht.get(id1)) == null) {
        System.out.println("CexchangePos hashtable: no such id1=" + id1);
        return;
      }
      if ( (icon2 = (AnimatorIcon) ht.get(id2)) == null) {
        System.out.println("CexchangePos hashtable: no such id2=" + id2);
        return;
      }
    }
    if (syncMode == XtangoAnimator.SYNC) {
...
class Cvis
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon = ht.get(id)) == null) {
        System.out.println("Cvis hashtable: no such id=" + id);
        return;
      }
    }
    if (action == Cvis.VIS) { // move to end opposite of current visibility
      ...
      if (oldVisibility == Cvis.RAISE) {
        ...
        System.out.println("Cvis: oldVisibility=" + oldVisibility
                           + " is incorrect");
      }
    }
      ...
      System.out.println("Cvis: action=" + action + " not implemented");
    }
    ...
    synchronized (icons) {
      if (newVisibility == Cvis.RAISE) {
        if (icons.removeElement(icon)) {
          ...
          System.out.println("Cvis: missing icon=" + icon);
        }
      }
        ...
        System.out.println("Cvis: newVisibility=" + newVisibility
...
class CswitchPos
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon1 = (AnimatorIcon) ht.get(id1)) == null) {
        System.out.println("CswitchPos hashtable: no such id1=" + id1);
        return;
      }
      if ( (icon2 = (AnimatorIcon) ht.get(id2)) == null) {
        System.out.println("CswitchPos hashtable: no such id2=" + id2);
        return;
      }
    }
...
class CswapIds
  ...
  void perform(AnimatorCanvas ac, Hashtable ht, Vector icons) {
    ...
    synchronized (ht) {
      if ( (icon1 = (AnimatorIcon) ht.get(id1)) == null) {
        System.out.println("CswapIds hashtable: no such id1=" + id1);
        return;
      }
      if ( (icon2 = (AnimatorIcon) ht.get(id2)) == null) {
        System.out.println("CswapIds hashtable: no such id2=" + id2);
        return;
      }
      if (id1.equals(id2)) {
        return;
      ...
      if (ht.remove(id1) == null) {
        System.out.println("CswapIds: internal remove error, id1=" + id1);
      }
      if (ht.remove(id2) == null) {
        System.out.println("CswapIds: internal remove error, id2=" + id2);
      }
      if (ht.put(id1, icon2) != null) {
        System.out.println("CswapIds: internal put error, id1=" + id1);
      }
      if (ht.put(id2, icon1) != null) {
        System.out.println("CswapIds: internal put error, id2=" + id2);
      }
    }
  }
...
abstract class AnimatorIcon
  ...
  void add(Hashtable ht, Vector icons) {
    ...
    if (old == null) {
      ...
      System.out.println
          ("System.outread add: non-null old should not have happened!!");
    }
  }
...
class Icircle
  ...
  synchronized void draw(AnimatorCanvas ac, Graphics g) {
    ...
    if (fillval == XtangoAnimator.SOLID) { // translate from center
      ...
      System.out.println("Icircle.draw(): fillval=" + fillval
                         + " not yet implemented");
    }
  }
...
class Iline
  ...
  synchronized void draw(AnimatorCanvas ac, Graphics g) {
    ...
    if (widthval == XtangoAnimator.THIN) {
      ...
      System.out.println("Iline.draw(): widthval=" + widthval
                         + " not yet implemented");
    }
  }
...
class Irectangle
  ...
  synchronized void draw(AnimatorCanvas ac, Graphics g) {
    ...
    if (fillval == XtangoAnimator.SOLID) { // translate from lower-left
      ...
      System.out.println("Irectangle.draw(): fillval=" + fillval
                         + " not yet implemented");
    }
  }
...
class Itext
  ...
  synchronized void draw(AnimatorCanvas ac, Graphics g) {
    ...
    if (size == Itext.SMALL) {
      ...
      System.out.println("Itext draw(): no size=" + size);
    }
    if (centered) {
